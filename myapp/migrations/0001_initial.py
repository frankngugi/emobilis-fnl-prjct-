# Generated by Django 5.0.3 on 2024-05-01 00:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('media_files', models.ManyToManyField(related_name='event_media', to='myapp.eventmedia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='Default image', upload_to='image/%y')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_started', models.DateTimeField(auto_now_add=True, null=True)),
                ('address', models.TextField()),
                ('events', models.ManyToManyField(blank=True, to='myapp.events')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('member_set', models.ManyToManyField(blank=True, related_name='groups', to='myapp.member')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('compeleted', 'Completed'), ('failed', 'Failed')], default='pending', max_length=20)),
                ...
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.events')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(default='Default video', upload_to='videos/%y')),
