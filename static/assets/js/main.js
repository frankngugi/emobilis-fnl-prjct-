...
(function() {
  ...
  // document.querySelector('.btn-learn-more').addEventListener('click', function(event) {
  //   event.preventDefault();
  //   document.querySelector('.row .content ul').classList.toggle('hidden');
  //   if (document.querySelector('.row .content ul').classList.contains('hidden')) {
